...
// Underapproximates impossible substrings for a sketch template of a given size by tracking
// impossible substrings that cannot fit inside an equal- or longer-length string, i.e.,
// if it does not fit in Σ^100, then it definitely will not fit in Σ^k<100. In the worst case
