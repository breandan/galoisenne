...
inline fun <reified T1, reified T2, reified T3, reified R>
    Any.asIntersection3(type: TypeWrapper3<T1, T2, T3>): R? where R : T1, R : T2, R : T3 =
  if (this is T1 && this is T2 && this is T3) this as R else null

interface Interface1 { val i1: String }
interface Interface2 { val i2: Int }
interface Interface3 { val i3: Boolean }
