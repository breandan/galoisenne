...
/*
./gradlew jvmTest --tests "ai.hypergraph.kaliningraph.parsing.SetValiantTest.testBarHillel"
*/
  @Test
  fun testBarHillel() {
...
[1,START,1] -> [1,N,2] [2,L,1]
[1,START,1] -> [1,N,3] [3,L,1]
[1,START,1] -> [1,N,4] [4,L,1]
[1,START,2] -> [1,N,1] [1,L,2]
[1,START,2] -> [1,N,2] [2,L,2]
[1,START,2] -> [1,N,3] [3,L,2]
[1,START,2] -> [1,N,4] [4,L,2]
[1,START,3] -> [1,N,1] [1,L,3]
[1,START,3] -> [1,N,2] [2,L,3]
[1,START,3] -> [1,N,3] [3,L,3]
[1,START,3] -> [1,N,4] [4,L,3]
[1,START,4] -> [1,N,1] [1,L,4]
[1,START,4] -> [1,N,2] [2,L,4]
...
[2,O,4] -> [2,x,4]
[2,O,4] -> [2,+,4]
[2,START,1] -> [2,N,1] [1,L,1]
[2,START,1] -> [2,N,2] [2,L,1]
[2,START,1] -> [2,N,3] [3,L,1]
[2,START,1] -> [2,N,4] [4,L,1]
[2,START,2] -> [2,N,1] [1,L,2]
[2,START,2] -> [2,N,2] [2,L,2]
[2,START,2] -> [2,N,3] [3,L,2]
[2,START,2] -> [2,N,4] [4,L,2]
[2,START,3] -> [2,N,1] [1,L,3]
[2,START,3] -> [2,N,2] [2,L,3]
[2,START,3] -> [2,N,3] [3,L,3]
[2,START,3] -> [2,N,4] [4,L,3]
[2,START,4] -> [2,N,1] [1,L,4]
[2,START,4] -> [2,N,2] [2,L,4]
[2,START,4] -> [2,N,3] [3,L,4]
[2,START,4] -> [2,N,4] [4,L,4]
[2,a,1] -> [2,ε,1] [1,a,1]
[2,a,1] -> [2,ε,2] [2,a,1]
[2,a,1] -> [2,ε,3] [3,a,1]
[2,a,1] -> [2,ε,4] [4,a,1]
...
[3,START,1] -> [3,N,2] [2,L,1]
[3,START,1] -> [3,N,3] [3,L,1]
[3,START,1] -> [3,N,4] [4,L,1]
[3,START,2] -> [3,N,1] [1,L,2]
[3,START,2] -> [3,N,2] [2,L,2]
[3,START,2] -> [3,N,3] [3,L,2]
[3,START,2] -> [3,N,4] [4,L,2]
[3,START,3] -> [3,N,1] [1,L,3]
[3,START,3] -> [3,N,2] [2,L,3]
[3,START,3] -> [3,N,3] [3,L,3]
[3,START,3] -> [3,N,4] [4,L,3]
[3,START,4] -> [3,N,1] [1,L,4]
[3,START,4] -> [3,N,2] [2,L,4]
...
[4,START,1] -> [4,N,2] [2,L,1]
[4,START,1] -> [4,N,3] [3,L,1]
[4,START,1] -> [4,N,4] [4,L,1]
[4,START,2] -> [4,N,1] [1,L,2]
[4,START,2] -> [4,N,2] [2,L,2]
[4,START,2] -> [4,N,3] [3,L,2]
[4,START,2] -> [4,N,4] [4,L,2]
[4,START,3] -> [4,N,1] [1,L,3]
[4,START,3] -> [4,N,2] [2,L,3]
[4,START,3] -> [4,N,3] [3,L,3]
[4,START,3] -> [4,N,4] [4,L,3]
[4,START,4] -> [4,N,1] [1,L,4]
[4,START,4] -> [4,N,2] [2,L,4]
...
[4,x,4] -> [4,ε,4] [4,x,4]
~[1,START,1] -> [1,START,1]
~[1,START,1] -> ~[1,START,1] [1,ε,1]
~[1,START,1] -> ~[1,START,2] [2,ε,1]
~[1,START,1] -> ~[1,START,3] [3,ε,1]
~[1,START,1] -> ~[1,START,4] [4,ε,1]
~[1,START,2] -> [1,START,2]
~[1,START,2] -> ~[1,START,1] [1,ε,2]
~[1,START,2] -> ~[1,START,2] [2,ε,2]
~[1,START,2] -> ~[1,START,3] [3,ε,2]
~[1,START,2] -> ~[1,START,4] [4,ε,2]
~[1,START,3] -> [1,START,3]
~[1,START,3] -> ~[1,START,1] [1,ε,3]
~[1,START,3] -> ~[1,START,2] [2,ε,3]
~[1,START,3] -> ~[1,START,3] [3,ε,3]
~[1,START,3] -> ~[1,START,4] [4,ε,3]
~[1,START,4] -> [1,START,4]
~[1,START,4] -> ~[1,START,1] [1,ε,4]
~[1,START,4] -> ~[1,START,2] [2,ε,4]
~[1,START,4] -> ~[1,START,3] [3,ε,4]
~[1,START,4] -> ~[1,START,4] [4,ε,4]
~[2,START,1] -> [2,START,1]
~[2,START,1] -> ~[2,START,1] [1,ε,1]
~[2,START,1] -> ~[2,START,2] [2,ε,1]
~[2,START,1] -> ~[2,START,3] [3,ε,1]
~[2,START,1] -> ~[2,START,4] [4,ε,1]
~[2,START,2] -> [2,START,2]
~[2,START,2] -> ~[2,START,1] [1,ε,2]
~[2,START,2] -> ~[2,START,2] [2,ε,2]
~[2,START,2] -> ~[2,START,3] [3,ε,2]
~[2,START,2] -> ~[2,START,4] [4,ε,2]
~[2,START,3] -> [2,START,3]
~[2,START,3] -> ~[2,START,1] [1,ε,3]
~[2,START,3] -> ~[2,START,2] [2,ε,3]
~[2,START,3] -> ~[2,START,3] [3,ε,3]
~[2,START,3] -> ~[2,START,4] [4,ε,3]
~[2,START,4] -> [2,START,4]
~[2,START,4] -> ~[2,START,1] [1,ε,4]
~[2,START,4] -> ~[2,START,2] [2,ε,4]
~[2,START,4] -> ~[2,START,3] [3,ε,4]
~[2,START,4] -> ~[2,START,4] [4,ε,4]
~[3,START,1] -> [3,START,1]
~[3,START,1] -> ~[3,START,1] [1,ε,1]
~[3,START,1] -> ~[3,START,2] [2,ε,1]
~[3,START,1] -> ~[3,START,3] [3,ε,1]
~[3,START,1] -> ~[3,START,4] [4,ε,1]
~[3,START,2] -> [3,START,2]
~[3,START,2] -> ~[3,START,1] [1,ε,2]
~[3,START,2] -> ~[3,START,2] [2,ε,2]
~[3,START,2] -> ~[3,START,3] [3,ε,2]
~[3,START,2] -> ~[3,START,4] [4,ε,2]
~[3,START,3] -> [3,START,3]
~[3,START,3] -> ~[3,START,1] [1,ε,3]
~[3,START,3] -> ~[3,START,2] [2,ε,3]
~[3,START,3] -> ~[3,START,3] [3,ε,3]
~[3,START,3] -> ~[3,START,4] [4,ε,3]
~[3,START,4] -> [3,START,4]
~[3,START,4] -> ~[3,START,1] [1,ε,4]
~[3,START,4] -> ~[3,START,2] [2,ε,4]
~[3,START,4] -> ~[3,START,3] [3,ε,4]
~[3,START,4] -> ~[3,START,4] [4,ε,4]
~[4,START,1] -> [4,START,1]
~[4,START,1] -> ~[4,START,1] [1,ε,1]
~[4,START,1] -> ~[4,START,2] [2,ε,1]
~[4,START,1] -> ~[4,START,3] [3,ε,1]
~[4,START,1] -> ~[4,START,4] [4,ε,1]
~[4,START,2] -> [4,START,2]
~[4,START,2] -> ~[4,START,1] [1,ε,2]
~[4,START,2] -> ~[4,START,2] [2,ε,2]
~[4,START,2] -> ~[4,START,3] [3,ε,2]
~[4,START,2] -> ~[4,START,4] [4,ε,2]
~[4,START,3] -> [4,START,3]
~[4,START,3] -> ~[4,START,1] [1,ε,3]
~[4,START,3] -> ~[4,START,2] [2,ε,3]
~[4,START,3] -> ~[4,START,3] [3,ε,3]
~[4,START,3] -> ~[4,START,4] [4,ε,3]
~[4,START,4] -> [4,START,4]
~[4,START,4] -> ~[4,START,1] [1,ε,4]
~[4,START,4] -> ~[4,START,2] [2,ε,4]
~[4,START,4] -> ~[4,START,3] [3,ε,4]
~[4,START,4] -> ~[4,START,4] [4,ε,4]
""".parseCFG().noNonterminalStubs
    ...
    println("Solutions:")
    measureTime {
//      bhcfg.solve("_ _ _ _ _ _ _", {it.weight}).onEach {
      bhcfg.solveSeq("_ _ _ _ _ _ _").onEach {
//        assertTrue { it in bhcfg.language } // Something funny going on here
        println(it) }.toList().also { println("Found ${it.size} solutions.") }
    }.also { println("Took: ${it.inWholeMilliseconds}ms") }

//    println(bhcfg.parse("a b a + b")!!.prettyPrint())
  }
}