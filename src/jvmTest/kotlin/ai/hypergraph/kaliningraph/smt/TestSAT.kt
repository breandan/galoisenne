...
*/
  ...
  fun testXujieMethod() = SMTInstance().solve {
    ...
    val decodedString = "[_()_[__]_()__".also { println("$it is being synthesized...") }
...
*/
  ...
  fun testXujieParsingWithFP() = SMTInstance().solve {
    ...
    val decodedString = "[X_+(_)______________________".also { println("$it is being synthesized...") }
            .synthesizeFromFPSolving(cfg, this)
...
*/
  ...
  fun testAlgebraicLanguage() = SMTInstance().solve {
    ...
    val decodedString = "X+__Z__*___".also { println("$it is being synthesized...") }
      .synthesizeFrom(cfg, this)
