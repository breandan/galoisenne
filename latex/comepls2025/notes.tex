...
\end{prooftree}
  however most of the synthetic productions will be non-generating or unreachable.
\end{definition}
...
\noindent Therefor, we only need $\lceil\log_2 |Q|\rceil$ squaring steps to determine the fixpoint. Finally,
