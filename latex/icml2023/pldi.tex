...
\node[state, initial] (00) {$q_{00}$};
\node[state, right of=00] (01) {$q_{01}$};
\node[state, right of=01] (02) {$q_{02}$};
\node[state, right of=02] (03) {$q_{03}$};
\node[right of=03] (04) {$\cdots$};
\node[accepting, state, right of=04] (0n) {$q_{0n}$};

\node[state, above of=00] (10) {$q_{10}$};
\node[state, right of=10] (11) {$q_{11}$};
\node[state, right of=11] (12) {$q_{12}$};
\node[state, right of=12] (13) {$q_{13}$};
\node[right of=13] (14) {$\cdots$};
\node[accepting, state, right of=14] (1n) {$q_{1n}$};

\node[above of=10] (q0) {$\vdots$};
\node[right of=q0] (q1) {$\vdots$};
\node[right of=q1] (q2) {$\vdots$};
\node[right of=q2] (q3) {$\vdots$};
\node[right of=q3] (q4) {$\ddots$};
\node[accepting, right of=q4] (qn) {$\vdots$};

\node[state, above of=q0] (k0) {$q_{k0}$};
\node[state, right of=k0] (k1) {$q_{k1}$};
\node[state, right of=k1] (k2) {$q_{k2}$};
\node[state, right of=k2] (k3) {$q_{k3}$};
\node[right of=k3] (k4) {$\cdots$};
\node[accepting, state, right of=k4] (kn) {$q_{kn}$};


\draw [->] (00) edge[below] node{$\sigma_1$} (01);
\draw [->] (01) edge[below] node{$\sigma_2$} (02);
\draw [->] (02) edge[below] node{$\sigma_3$} (03);
\draw [->] (03) edge[below] node{} (04);
\draw [->] (04) edge[below] node{$\sigma_n$} (0n);

\draw [->] (10) edge[below] node{$\sigma_1$} (11);
\draw [->] (11) edge[below] node{$\sigma_2$} (12);
\draw [->] (12) edge[below] node{$\sigma_3$} (13);
\draw [->] (13) edge[below] node{} (14);
\draw [->] (14) edge[below] node{$\sigma_n$} (1n);

\draw [->] (q0) edge[below] node{$\sigma_1$} (q1);
\draw [->] (q1) edge[below] node{$\sigma_2$} (q2);
\draw [->] (q2) edge[below] node{$\sigma_3$} (q3);
\draw [->] (q3) edge[below] node{} (q4);
\draw [->] (q4) edge[below] node{$\sigma_n$} (qn);

\draw [->] (k0) edge[below] node{$\sigma_1$} (k1);
\draw [->] (k1) edge[below] node{$\sigma_2$} (k2);
\draw [->] (k2) edge[below] node{$\sigma_3$} (k3);
\draw [->] (k3) edge[below] node{} (k4);
\draw [->] (k4) edge[below] node{$\sigma_n$} (kn);

\draw [->] (00) edge[left] node{$*$} (11);
\draw [->] (01) edge[left] node{$*$} (12);
\draw [->] (02) edge[left] node{$*$} (13);
\draw [->] (03) edge[left] node{$*$} (14);

\draw [->] (10) edge[left] node{$*$} (q1);
\draw [->] (11) edge[left] node{$*$} (q2);
\draw [->] (12) edge[left] node{$*$} (q3);
\draw [->] (13) edge[left] node{$*$} (q4);

\draw [->] (q0) edge[left] node{$*$} (k1);
\draw [->] (q1) edge[left] node{$*$} (k2);
\draw [->] (q2) edge[left] node{$*$} (k3);
\draw [->] (q3) edge[left] node{$*$} (k4);

\draw [->] (00) edge[bend left, left] node{$*$} (10);
\draw [->] (01) edge[bend left, left] node{$*$} (11);
\draw [->] (02) edge[bend left, left] node{$*$} (12);
\draw [->] (03) edge[bend left, left] node{$*$} (13);
\draw [->] (04) edge[bend left, left] node{$*$} (14);
\draw [->] (0n) edge[bend left, left] node{$*$} (1n);

\draw [->] (10) edge[bend left, left] node{$*$} (q0);
\draw [->] (11) edge[bend left, left] node{$*$} (q1);
\draw [->] (12) edge[bend left, left] node{$*$} (q2);
\draw [->] (13) edge[bend left, left] node{$*$} (q3);
\draw [->] (14) edge[bend left, left] node{$*$} (q4);
\draw [->] (1n) edge[bend left, left] node{$*$} (qn);

\draw [->] (q0) edge[bend left, left] node{$*$} (k0);
\draw [->] (q1) edge[bend left, left] node{$*$} (k1);
\draw [->] (q2) edge[bend left, left] node{$*$} (k2);
\draw [->] (q3) edge[bend left, left] node{$*$} (k3);
\draw [->] (q4) edge[bend left, left] node{$*$} (k4);
\draw [->] (qn) edge[bend left, left] node{$*$} (kn);

\draw [->] (00) edge[below] node{$\sigma_2$} (12);
\draw [->] (01) edge[below] node{$\sigma_3$} (13);
\draw [->] (02) edge[below] node{$\sigma_4$} (14);

\draw [->] (10) edge[below] node{$\sigma_2$} (q2);
\draw [->] (11) edge[below] node{$\sigma_3$} (q3);
\draw [->] (12) edge[below] node{$\sigma_4$} (q4);

\draw [->] (q0) edge[below] node{$\sigma_2$} (k2);
\draw [->] (q1) edge[below] node{$\sigma_3$} (k3);
\draw [->] (q2) edge[below] node{$\sigma_4$} (k4);
