...
\node[state, right of=00] (01) {};
\node[state, right of=01] (02) {};
\node[state, right of=02] (03) {};
\node[right of=03] (04) {$\cdots$};
\node[accepting, state, right of=04] (0n) {S};

\node[state, above of=00] (10) {};
\node[state, right of=10] (11) {};
\node[state, right of=11] (12) {};
\node[state, right of=12] (13) {};
\node[right of=13] (14) {$\cdots$};
\node[accepting, state, right of=14] (1n) {};
...
\node[state, above of=q0] (k0) {};
\node[state, right of=k0] (k1) {};
\node[state, right of=k1] (k2) {};
\node[state, right of=k2] (k3) {};
\node[right of=k3] (k4) {$\cdots$};
\node[accepting, state, right of=k4] (kn) {};
