...
There are three major areas where our work is related to existing research: (1) language reachability, (2) program synthesis, and (3) error correction. We survey each of these areas in turn.
