...
\newcommand*{\lattice}{Lattice~\citep{dolan2017algebraic}}
\newcommand*{\gadt}{[G]ADT~\citep{kennedy2005generalized}}
...
\begin{tabular}{l|llllll}
  ...
  \textbf{Types}    & \lattice           &                   & \STM          & \TLP            & \done [G]ADT      \\
  \textbf{CFGs}     & \done \REACH       & \HOAS             &               & \done \valiant  & \done GF(2)       \\
