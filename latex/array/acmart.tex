...
\noindent looks a lot like a CFG! We use this observation to design a DSL for parsing graphs and visualizing CFGs. In fact, we can often translate between these and related structures. Depicted below are just a few entries in this transition matrix.
...
\begin{tabular}{l|llllll}
  ...
  \textbf{CFGs}     & \done Reachability & HOAS              &               & \done \valiant  & \done GF(2)       \\
...
Although we have only explored a very small subset of this design space, we believe it sheds light on many fascinating similarities between programming languages, graphs and linear algebra, and contains yet-undiscovered applications for array programming and program synthesis. Among the applications we have encountered is a direct path to lowering sketch-based program synthesis to SAT/SMT theories and composing probabilistic programs.
