...
\begin{document}
    ...
    \begin{frame}
        ...
        \noindent We initialize $\mathbf{M}^0_{i,j}(\mathcal{G}, \sigma) \coloneqq \{A \mid i + 1 = j, (A \rightarrow \sigma_i) \in P\}$ and search for a matrix $\mathbf{M}^*$ via fixpoint iteration,
    ...
    \begin{frame}
        ...
        \begin{itemize}
            ...
            \item \href{http://theory.stanford.edu/~virgi/cs367/papers/valiantcfg.pdf}{Valiant (1975) - realizes Boolean matrix multiplication correspondence}
