...
\begin{document}
    ...
    \begin{frame}
        \frametitle{Recap: Classical Logic}
        \begin{prooftree}
            \bottomAlignProof
            \AxiomC{$a \veebar b$}
            \RightLabel{XOR}
        ...
        \end{column}
            \begin{column}{0.5\textwidth}  %%<--- here
                ...
                \begin{prooftree}
                    \AxiomC{$x + (y \land \neg z)$}
                    \RightLabel{}
                    \UnaryInfC{$x + (y(1 \veebar z))$}
                    \RightLabel{}
                    \UnaryInfC{$x + (y \veebar yz)$}
                    \RightLabel{}
                    \UnaryInfC{$x \veebar (y \veebar yz) \veebar x(y \veebar yz)$}
                    \RightLabel{}
                    \UnaryInfC{$x \veebar y \veebar xy \veebar yz \veebar xyz$}
                \end{prooftree}
                \end{center}
            \end{column}
        \end{columns}
    ...
    \begin{frame}
        ...
        \item Algebra: Zhegalkin Normal Form (ZNF). It is unique.
        \end{itemize}
