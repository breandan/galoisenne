...
%    \end{tikzpicture}
  ...
  Next, we measure the precision at various ranking cutoffs for varying wall-clock timeouts. Here, Precision@\{k=1, 5, 10, All\} indicates the percentage of syntax errors with a human repair that was located within the top-k results, based on n-gram likelihood.
