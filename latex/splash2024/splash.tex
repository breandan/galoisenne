...
%  \email{six@utoronto.ca}}
  ...
  \begin{enumerate}
    ...
    \item To extract the repairs, we sample trees without replacement by constructing a bijection between syntax trees and integers, sample integers uniformly without replacement from a finite range, then decode them as trees.
