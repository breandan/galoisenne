...
\end{prooftree}\vspace{0.2cm}
 ...
 \end{equation*}
  ...
  \begin{prooftree}
    ...
    \RightLabel{$P_V$}
    \UnaryInfC{$\bigcup_{i=0}^n\{\sigma_i\} \setminus \Sigma \subseteq V$}
    \DisplayProof
    \hskip 1em
    \AxiomC{$(\sigma_0 \rightarrow \sigma_{1..n}) \in P$}
    \RightLabel{$P_\Sigma$}
    \UnaryInfC{$\bigcup_{i=1}^n \{\sigma_i\} \setminus V \subseteq \Sigma$}
  \end{prooftree}
  \end{small}
  ...
  \begin{figure}[H]
    ...
    \begin{minipage}{0.49\columnwidth}
      ...
      \begin{tikzpicture}
        ...
        xlabel={Length ($|\sigma|=n$)}, ylabel={$\mu$ TTFS (ms)},
