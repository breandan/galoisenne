...
% -------------------------------------------------
\begin{frame}{Example language: static semantics}
  \vspace{-0.3cm}
  \begin{center}
    \begin{prooftree}
      \hskip -1em
...
\begin{frame}{Sampling star-free regular expressions uniformly}
  ...
  \begin{theorem}[Uniform tree enumeration]
    ...
    n.b. may need to disambiguate to guarantee $\mathcal{L}(e)$ uniformity.
  \end{theorem}
\end{frame}
...
\vspace{0.2cm}
  ...
  where $\delta_s e$ is the Brzozowskian derivative (1973) and $\leftsquigarrow$ denotes probabilistic choice from a small finite set. This may be augmented with a weighted choice operator, $P_\theta\,(\sigma_{n} \mid  \sigma_{n-1}, \cdots, \sigma_{n - k})$.
\end{frame}
