...
% =========================================================
    ...
    \null\hspace*{2.8cm}\begin{minipage}[c]{0.86\columnwidth}
        Finite slices of a CFL are finite and therefore regular. We use star free regular expressions as a compact algebra for propagating regular constraints during parsing and decoding. Let \( e: E \) be an expression defined by the grammar:\vspace{0.4cm}
        \[
          e \rightarrow \varnothing \mid \varepsilon \mid \Sigma \mid e \cdot e \mid e \lor e \mid e \land e
        \]
        \vspace{0.5cm}where $\varepsilon$ is the empty symbol and $\Sigma$ is a finite alphabet. We interpret these expressions as denoting regular languages, where $a \in \Sigma$:
    \end{minipage}
