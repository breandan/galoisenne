...
\begin{frame}[fragile]{On the virtues of pragmatism}
  ...
  \begin{itemize}
    ...
    \item Practiced seriously, pragmatism is difficult because it requires faithfully modeling the needs of multiple stakeholders.
  ...
  \begin{columns}[T]
    \begin{column}{0.9\textwidth}
      \begin{itemize}
        ...
        \item Assume a sympathetic speaker, who is trying \\to communicate something meaningful.
      \end{itemize}
    \end{column}
