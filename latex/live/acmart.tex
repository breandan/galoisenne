...
\end{verbatim}
\noindent\hspace{0.96cm}\emoji{herb}\hspace{1.70cm}\emoji{herb}\hspace{1.98cm}\emoji{herb}\vspace{-5pt}
\begin{verbatim}
      └── ! [3]   └── and [4]   └── false [5]
\end{verbatim}
\noindent\hspace{0.96cm}\emoji{herb}\hspace{1.70cm}\emoji{herb}\vspace{-5pt}
\begin{verbatim}
      └── or [6]  └── true [7]
\end{verbatim}
\hspace{0.96cm}\emoji{herb}\hspace{3.4cm}\emoji{herb}\vspace{-5pt}
\begin{verbatim}
      └── S [0..2]          └── S [8..11]
          ├── true [0]          ├── S [8..9]
          ├── and [1]           │   ├── ! [8]
