...
\newcommand{\substitutionExample}{
  \tikz{
    ...
    \draw [orange,-to] (16pt,0pt) -- (24pt,8pt);
...
\newcommand{\insertionExample}{
  \tikz{
    ...
    \draw [green,-to] (24pt,0pt) -- (16pt,8pt);
...
\newcommand{\deletionExample}{
  \tikz{
    ...
    \draw [red!85,-to] (24pt,0pt) -- (40pt,8pt);
  }
}
...
\newcommand{\doubleDeletionExample}{
  \tikz{
    ...
    \draw [red!70,-to] (0pt,0pt) -- (24pt,16pt);
...
\newcommand{\subDelExample}{
  \tikz{
    ...
    \draw [-to] (0pt,0pt) -- (8pt,0pt);
    \draw [orange,-to] (8pt,0pt) -- (16pt,8pt);
    \draw [red!85,-to] (16pt,8pt) -- (32pt,16pt);
    \draw [-to] (32pt,16pt) -- (40pt,16pt);
  }
}
...
\newcommand{\subSubExample}{
  \tikz{
    ...
    \draw [-to] (0pt,0pt) -- (8pt,0pt);
    \draw [orange,-to] (8pt,0pt) -- (16pt,8pt);
    \draw [orange,-to] (16pt,8pt) -- (24pt,16pt);
    \draw [-to] (24pt,16pt) -- (32pt,16pt);
    \draw [-to] (32pt,16pt) -- (40pt,16pt);
  }
}
...
\newcommand{\insertDeleteExample}{
  \tikz{
    ...
    \draw [green,-to] (16pt,0pt) -- (8pt,8pt);
    \draw [-to] (8pt,8pt) -- (24pt,8pt);
    \draw [red!85,-to] (24pt,8pt) -- (40pt,16pt);
