...
ylabel={Frequency},
title={\hspace{-0.5cm}\large\textbf{Cumulative length distribution}},
axis x line*=bottom,
axis y line*=left,
ymin=0,
ymax=65,
...
ybar,
bar width=5pt,
title={\large\textbf{Human repair distance}},
xlabel={Edit distance, $\Delta(\err\sigma, \sigma^\star)$},
ylabel={Frequency},
axis x line*=bottom,
axis y line*=left,
xtick=data,
...
\draw[red, dashed] (axis cs:3.5,0) -- (axis cs:3.5,80);
\end{axis}
\end{tikzpicture}
\begin{tikzpicture}[scale=0.57]
\begin{axis}[
...
ylabel={Frequency},
title={\large\textbf{Normalized edit locations\vphantom{p}}},
axis x line*=bottom,
axis y line*=left,
ymin=0,
ymax=35,
...
title={\large\textbf{Stability profile}},
ybar,
axis lines*=left,
