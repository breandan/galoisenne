...
\subsection{Mapping source code to formal languages}
...
Assume there exists a tokenizer from Unicode tokens to grammatical tokens, $\tau : (\Sigma_U^*) \rightarrow \Sigma_G$. Thus, the source language can be described as $\tau^{-1}(L(G))$.
