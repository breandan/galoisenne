...
From the lexical string, we build an automaton that represents all possible strings within a certain edit distance. We then proceed to stich this automaton together with a grammar to produce a regular expression. This regular expression is decoded with the help of a statistical model to produce a list of suggested repairs, which is reranked and truncated. This we depict in Fig. \ref{fig:arch_simp}.
