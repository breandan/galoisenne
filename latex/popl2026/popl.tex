...
\begin{figure}[H]
  \begin{center}
  \includegraphics[width=4cm]{figures/lev_nfa_6x1.pdf}\hspace{0.5cm}
    \resizebox{0.4\textwidth}{!}{%
...
\begin{figure}[H]
  \begin{center}
\includegraphics[width=4cm]{figures/lev_nfa_6x2.pdf}\hspace{0.5cm}
    \resizebox{0.4\textwidth}{!}{%
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=4cm]{figures/lev_nfa_6x3.pdf}\hspace{0.5cm}
  \resizebox{0.4\textwidth}{!}{%
...
\begin{figure}[H]
  \begin{center}
\includegraphics[height=4cm]{figures/lev_nfa_6x4.pdf}\hspace{0.5cm}
    \resizebox{0.4\textwidth}{!}{%
