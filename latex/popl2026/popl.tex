...
\section{Method}
  ...
  In the case of ordinary parsing, the automaton accepts a single word, the word to be parsed:
...
\begin{figure}[H]
  ...
  Here the automaton takes a similar shape, but can have multiple arcs between subsequent states:
