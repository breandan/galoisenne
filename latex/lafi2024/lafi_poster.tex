...
\null\hspace*{3cm}\begin{minipage}[c]{0.85\columnwidth}
CFL membership is recognized by $R(G', \sigma) \coloneqq [S \in \Lambda^*_\sigma] \Leftrightarrow [\sigma \in \mathcal{L}(G)]$.
\end{minipage}
...
\end{tabular}\\
      ...
      This procedure returns whether $\exists \sigma' \in \mathcal{L}(G) \mid \sigma' \sqsubseteq \sigma$ but forgets provenance.
      \end{minipage}
      \jointspacing
