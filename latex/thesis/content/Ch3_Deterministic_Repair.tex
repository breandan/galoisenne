...
\begin{proof}
  ...
  \[
    ...
    \end{cases}
  \]
  Each level of recursion requires at most two parallel matrix multiplication steps, which requires $\mathcal{O}(\lceil \log_2 n \rceil)$ individual matrix multiplications.
\end{proof}
