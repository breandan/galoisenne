...
%        \end{minipage}
      ...
      \hspace*{2.5cm}\begin{minipage}[c]{0.90\columnwidth}
       ...
       \noindent As $c \rightarrow \infty$, this shape approximates a circular cone whose symmetric axis intersects orthonormal CNF unit productions $w_i \rightarrow t$, with $S_i \in \mathcal{T}_{i}?$ encoded by bitvectors on the base perimeter. Equations of this form are equiexpressive with the family of CSLs realizable by finite CFL intersection.
      \end{minipage}
      }
