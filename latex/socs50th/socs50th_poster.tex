...
%      \jointspacing
      ...
      \null\hspace*{3cm}\begin{minipage}[c]{0.90\columnwidth}
      \begin{itemize}
        \item CYK parsers can be lowered onto $\mathbb{Z}_2^{|V|\times n\times n}$ or $\mathcal{M}: (\mathbb{Z}_2^p\rightarrow\mathbb{Z}_2)^{|V|\times n\times n}$
...
%      \jointspacing
      ...
      \begin{center}
        \begin{tabular}{ccccccc}
          ...
          $x \otimes y = \big\{\;w \mid (w \rightarrow x y)\;\big\}$ &&&
          $\frac{\partial f}{\partial \cev{x}} = \big\{\;y \mid (w \rightarrow x y)\;\big\}$ &&&
          $\frac{\partial f}{\partial \vec{y}} = \big\{\;x \mid (w \rightarrow x y)\;\big\}$ \\\\
          \begin{tabular}{|c|c|}
            \hline
...
%        \end{minipage}
      ...
      \hspace*{2.5cm}\begin{minipage}[c]{0.90\columnwidth}
       ...
       \noindent As $c \rightarrow \infty$, this shape approximates a circular cone whose symmetric axis intersects orthogonal CNF unit productions $w_i \rightarrow t$, with $S_i \in \mathcal{T}_{i}$ represented by bitvectors on the base perimeter. Equations of this form are equiexpressive with the family of CSLs realizable by finite CFL intersection.
      \end{minipage}
      }
