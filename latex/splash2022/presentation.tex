    ...
    \begin{frame}[fragile]{Background: Closure properties of formal languages}
        ...
        \begin{table}
            \begin{tabular}{c|ccccc}
                ...
                Context-free & \cmark & \cmark & \cmark & \cmark & \cmark \\
                Conjunctive & \cmark & \cmark & \cmark & \cmark & \cmark \\
                Context-sensitive & \cmark & \cmark & \cmark & \cmark & \cmark \\
                Recursively Enumerable & \cmark & \cmark & \cmark & \cmark & \cmark \\
            \end{tabular}
        \end{table}
    \end{frame}
