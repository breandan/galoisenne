...
\begin{document}
    ...
    \begin{frame}{Background: Conjunctive grammars}
        Conjunctive grammars naturally extend CFGs with language union, intersection and complementation, respecting closure under those operations. Equivalent to trellis automata, which are like contractive ellementary cellular automata. Language inclusion is decidable in P.\\
    ...
    \begin{frame}[fragile]{Trellis Automata}
        \begin{tabular}{ c c }
        \includegraphics[width=0.35\textwidth]{../figures/jiaxian_triangle.png} & \scalebox{0.47}{\mkJiaxian{9}}\\
        Jia Xian Triangle (Jia, $\~1030$ A.D.) & Trellis Automaton (Dyer, 1980 A.D.)
        \end{tabular}
    \end{frame}
...
%            \item Set joins are an active topic of research in SQL query optimization
    ...
    We can lower Valiant's algorithm onto a polynomial system of equations over finite fields.
    \begin{figure}[H]
